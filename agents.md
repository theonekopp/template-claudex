# Codex CLI platform config. Source of truth is CLAUDE.md — keep in sync when editing there.
...
- Favor simplicity and portability over cleverness; never perform write operations to external services unless the user explicitly authorizes it in the current session.
